...
class RegProp extends StatefulWidget {
  const RegProp({super.key});

  @override
  State<RegProp> createState() => _RegPropState();
}
                      ...
                      ElevatedButton(
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              controlp.createProp(propData, _image);
                              Get.toNamed("/places");
                            }
                          },
                          style: ButtonStyle(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: IconButton(
                                  ...
                                  onPressed: () {
                                    controlp.listProp().then(
                                        (value) => Get.toNamed("/places"));
                                  }),
                            )
                          ])
                    ],
